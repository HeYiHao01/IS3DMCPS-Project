 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/is3dmcps/isPart")
public class IsPartController extends BaseController {
	...
	public String list(IsDevice isDevice, Model model) {
		...
		return "modules/is3dmcps/isPartList";
	}
	...
	public String index(IsDevice isDevice, Model model) {
		model.addAttribute("isDevice", isDevice);
		return "modules/is3dmcps/isPartIndex";
	}
	...
	public String form(IsDevice isDevice, Model model) {
		model.addAttribute("isDevice", isDevice);
		return "modules/is3dmcps/isPartForm";
	}
	/**
	 * 新增备件表单
	 */
	...
	public String newForm(IsDevice isDevice, Model model) {
		model.addAttribute("isDevice", isDevice);
		return "modules/is3dmcps/isPartNewForm";
	}
	/**
	 * 零件启用表单
	 */
	...
	public String enableForm(IsDevice isDevice, Model model) {
		model.addAttribute("isDevice", isDevice);
		return "modules/is3dmcps/isPartEnableForm";
	}
	...
	@ResponseBody
	public String ebable(@Validated IsDevice isDevice) {
		...
		return renderResult(Global.TRUE, text("启用零部件成功！"));
	}
